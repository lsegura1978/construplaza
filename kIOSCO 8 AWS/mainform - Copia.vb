...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.StatusBar.Location = New System.Drawing.Point(0, 580)
        Me.StatusBar.Name = "StatusBar"
        Me.StatusBar.Size = New System.Drawing.Size(965, 24)
        ...
        Me.groupBox4.Controls.Add(Me.GetLiveImageBtn)
        ...
        Me.GetLiveImageBtn.Location = New System.Drawing.Point(17, 131)
        Me.GetLiveImageBtn.Name = "GetLiveImageBtn"
        Me.GetLiveImageBtn.Size = New System.Drawing.Size(131, 138)
        Me.GetLiveImageBtn.TabIndex = 8
        Me.GetLiveImageBtn.Text = "Captura de huella"
        ...
        Me.pictureBox1.Size = New System.Drawing.Size(292, 437)
        ...
        Me.GroupBox5.Location = New System.Drawing.Point(500, 67)
        Me.GroupBox5.Name = "GroupBox5"
        Me.GroupBox5.Size = New System.Drawing.Size(448, 507)
        ...
        Me.Button12.Font = New System.Drawing.Font("Microsoft Sans Serif", 17.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.Button12.Text = "Ingresar"
        Me.Button12.UseVisualStyleBackColor = True
        '
        'Button11
        '
        Me.Button11.Font = New System.Drawing.Font("Microsoft Sans Serif", 17.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        'Button10
        '
        Me.Button10.Font = New System.Drawing.Font("Microsoft Sans Serif", 17.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        'Button9
        '
        Me.Button9.Font = New System.Drawing.Font("Microsoft Sans Serif", 17.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        'Button8
        '
        Me.Button8.Font = New System.Drawing.Font("Microsoft Sans Serif", 17.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.GroupBox7.Location = New System.Drawing.Point(500, 8)
        ...
        Me.ClientSize = New System.Drawing.Size(965, 604)
...
#End Region
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If contadores >= 4 Then
            ...
            With cmdconsulta
                .Connection = conexion
                .CommandText = "SELECT NOMBRE FROM EXACTUS.digema.EMPLEADO WHERE EMPLEADO='" & txtempleado.Text & "' "
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button12.Click
        ...
        With cmdconsulta
            .Connection = conexion
            .CommandText = "select EMPLEADO from ASISTENCIA.DBO.EMPLEADO_HUELLA where EMPLEADO='" & txtempleado.Text & "'"
            .CommandType = CommandType.Text
        End With
        daconsulta.SelectCommand = cmdconsulta
        daconsulta.Fill(dsconsulta)
        ...
        If bandera = False And txtnombre.Text.Trim.Length > 0 Then
            ...
            Using myConn As New Data.SqlClient.SqlConnection("Server=DIGEMA0020080\BDAPP01;Database=ASISTENCIA;User Id=SA;Password=Igoloncet!2;")
                Dim myCommand As New Data.SqlClient.SqlCommand("INSERT INTO ASISTENCIA.DBO.EMPLEADO_HUELLA(EMPLEADO,HUELLA) VALUES (@empleado,@img_data)", myConn)
        ...
        If bandera = True Or txtnombre.Text.Trim.Length = 0 Then
            MsgBox("NO SE Ingreso el empleado:  " & txtempleado.Text & "   " & txtnombre.Text & "   " & " ya se ecuentra incluido", MsgBoxStyle.Critical, "Construplaza")
        End If
