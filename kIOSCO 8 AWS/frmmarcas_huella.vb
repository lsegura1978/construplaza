...
Public Class frmmarcas_huella

    Public cmdconsulta, cmdconsulta_total, cmdconsulta_licencia, cmdconsulta_licencia_previa, cmdconsulta_total_tardias, cmdconsulta_ubicacion, cmdconsulta_chofer, cmdconsulta_documentos As SqlClient.SqlCommand
    Public transaccion, transaccion_total, transaccion_licencia, transaccion_licencia_previa, transaccion_total_tardias, transaccion_ubicacion, transaccion_chofer, transaccion_documentos As SqlClient.SqlTransaction
    Public cmdincluir, cmdincluir_total, cmdincluir_licencia, cmdincluir_licencia_previa, cmdincluir_total_tardias, cmdincluir_ubicacion, cmdincluir_chofer, cmdincluir_documentos As SqlClient.SqlCommand
    ...
    Public daconsulta, daconsulta_total, daconsulta_licencia, daconsulta_licencia_previa, daconsulta_total_tardias, daconsulta_ubicacion, daconsulta_chofer, daconsulta_documentos As SqlClient.SqlDataAdapter
    Public dsconsulta, dsconsulta_total, dsconsulta_licencia, dsconsulta_licencia_previa, dsconsulta_total_tardias, dsconsulta_ubicacion, dsconsulta_chofer, dsconsulta_documentos As DataSet
    ...
    Public fecha_licencia As String
    Public nom_expirado As String
    ...
    Public bandera_licencia As Boolean = False
    ...
    Private Sub frmmarcas_huella_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If bandera_error = False Then
                ...
                If emplea2_encontrado = "NO" And encontrado = False Then
                    ...
                    Formmenu.btnclave.BackColor = Color.Red
                    Formmenu.btnactualizacion.BackColor = Color.Red
                ...
                '-----------------------------------------------------------------------------------mensaje advertencia licencia------------------------------------------------------


                cmdconsulta_licencia_previa = New SqlClient.SqlCommand
                daconsulta_licencia_previa = New SqlClient.SqlDataAdapter
                dsconsulta_licencia_previa = New DataSet
                With cmdconsulta_licencia_previa
                    .Connection = conexion
                    .CommandText = "SELECT E.EMPLEADO,E.NOMBRE,P.DESCRIPCION,CONVERT(datetime, E.RUBRO11, 103)AS FECHA_EXPIRACION_LICENCIA FROM EXACTUS.DIGEMA.EMPLEADO E INNER JOIN EXACTUS.DIGEMA.PUESTO P ON P.PUESTO=E.PUESTO AND E.ACTIVO='S' AND (P.DESCRIPCION LIKE '%Chofer%' or P.DESCRIPCION LIKE '%Montacarg%') AND CONVERT(datetime, E.RUBRO11, 103) >= GETDATE() AND CONVERT(datetime, E.RUBRO11, 103) <= (GETDATE() + 30) and E.EMPLEADO='" & emplea2_encontrado & "'"



                    .CommandType = CommandType.Text
                End With
                daconsulta_licencia_previa.SelectCommand = cmdconsulta_licencia_previa
                daconsulta_licencia_previa.Fill(dsconsulta_licencia_previa)


                For i = 0 To dsconsulta_licencia_previa.Tables(0).Rows.Count - 1

                    fecha_licencia = dsconsulta_licencia_previa.Tables(0).Rows(i).Item("FECHA_EXPIRACION_LICENCIA")
                    nom_expirado = dsconsulta_licencia_previa.Tables(0).Rows(i).Item("NOMBRE")

                    MsgBox("Estimado " & nom_expirado & " su licencia de conducir se encuenta pronta a vencer (" & fecha_licencia & "), favor comunicarse con RRHH para la actualización de la fecha de vencimiento", MsgBoxStyle.Exclamation, "Construplaza")
                ...
                '----------------------------------------------------------------------bandera licencia-----------------------------------------------------------------------------
                bandera_licencia = False


                cmdconsulta_licencia = New SqlClient.SqlCommand
                daconsulta_licencia = New SqlClient.SqlDataAdapter
                dsconsulta_licencia = New DataSet
                With cmdconsulta_licencia
                    .Connection = conexion
                    .CommandText = "SELECT E.EMPLEADO,E.NOMBRE,P.DESCRIPCION,CONVERT(datetime, E.RUBRO11, 103)AS FECHA_EXPIRACION_LICENCIA FROM EXACTUS.DIGEMA.EMPLEADO E INNER JOIN EXACTUS.DIGEMA.PUESTO P ON P.PUESTO=E.PUESTO AND E.ACTIVO='S' AND (P.DESCRIPCION LIKE '%Chofer%' or P.DESCRIPCION LIKE '%Montacarg%') AND CONVERT(datetime, E.RUBRO11, 103) <= GETDATE() and E.EMPLEADO='" & emplea2_encontrado & "'"



                    .CommandType = CommandType.Text
                End With
                daconsulta_licencia.SelectCommand = cmdconsulta_licencia
                daconsulta_licencia.Fill(dsconsulta_licencia)


                For i = 0 To dsconsulta_licencia.Tables(0).Rows.Count - 1

                    bandera_licencia = True

                    MsgBox("Su licencia de conducir se reporta como vencida, favor comunicarse con RRHH para la actualización de la fecha de vencimiento", MsgBoxStyle.Critical, "Construplaza")
                ...
                texto2.Text = "Sin tardías en el mes "
                If cuenta_tardias > 0 Then
                    texto2.Text = ""
                    texto2.Text = "Usted lleva " & cuenta_tardias & " tardías en el mes, se le recuerda que después de la quinta tardía, se tomará un día como ausente "
                ...
                If emplea2_encontrado <> "NO" And encontrado = True And bandera_total = False And bandera_ubicacion = False And bandera_licencia = False Then
                    ...
                    Formmenu.btnclave.BackColor = Color.Green
                    Formmenu.btnactualizacion.BackColor = Color.Green
                    Formmenu.Button1.Text = "Marcar"
                    m_FPM.CloseDevice()
                        ...
                        If DIA <> "LIBRE" Then
                            ...
                            If HORACHEQUEO > 12 Then
                                ...
                                If ESTADON = "TARDIA" And emplea2_encontrado <> "NO" And encontrado = True Then
                                    ...
                                    Formmenu.btnclave.BackColor = Color.Yellow
                                    Formmenu.btnactualizacion.BackColor = Color.Yellow
                                    Formmenu.Button1.Text = "Marcar"
                                    m_FPM.CloseDevice()
                                ...
                                If ESTADON = "AUSENTE" And emplea2_encontrado <> "NO" And encontrado = True Then
                                    ...
                                    Formmenu.btnclave.BackColor = Color.Black
                                    Formmenu.btnactualizacion.BackColor = Color.Black
                                    Formmenu.Button1.Text = "Marcar"
                                    m_FPM.CloseDevice()
                ...
                ' MessageBox.Show("Estimados compañeros: Se agregó recientemente la opción de actualización de empleado. Por favor actualizar sus datos personales a más tardar el 31 de julio de 2021, si no lo hace quedará bloqueado su usuario. Debe hacerlo en su tiempo de descanso, de modo que no entorpezca las horas de entrada y salida del personal.", "Construplaza", MessageBoxButtons.OK)
            ...
            If bandera_error = True Or encontrado = False Then
                ...
                Formmenu.btnclave.BackColor = Color.Gray
                Formmenu.btnactualizacion.BackColor = Color.Gray
                Formmenu.Button1.Text = "Marcar"
                m_FPM.CloseDevice()
