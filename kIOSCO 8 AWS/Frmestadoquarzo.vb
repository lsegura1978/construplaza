...
Public Class Frmestadoquarzo
    Public ws As Quarzo.ServiceNubeAseconstruPlazaSoapClient
    ...
    Private Sub Frmestadoquarzo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If iError = SGFPMError.ERROR_NONE Then
                ...
                Else
                    ...
                    bandera_error = True
                    m_FPM.CloseDevice()
                    MsgBox("No se pudo leer su huella, favor intente de nuevo")
        ...
        Dim ws As com.quarzo.gestiones6.ServiceNubeAseconstruPlaza = New com.quarzo.gestiones6.ServiceNubeAseconstruPlaza()
                ...
                ListView1.Columns.Add("AHORRO", 195, HorizontalAlignment.Left)
                ListView1.Columns.Add("TOTAL", 170, HorizontalAlignment.Left)
                ...
                ' For Each credito As com.quarzo.gestiones6.BECrPrestamo In ws.Met_CreditosPorAsociado(credenciales, emplea2_encontrado)
                For Each ahorros As com.quarzo.gestiones6.BEDeDeducAso In ws.Met_AhorrosPorAsociado(credenciales, emplea2_encontrado)

                    str(0) = (ahorros.cDesDeducc)
                    str(1) = (ahorros.nMtoPrinci).ToString("N2")

                    TotalAhorro = TotalAhorro + (ahorros.nMtoPrinci)
                ...
                ListView2.Columns.Add("CREDITO", 200, HorizontalAlignment.Left)
                ListView2.Columns.Add("PRINCIPAL", 140, HorizontalAlignment.Left)
                ListView2.Columns.Add("SALDO", 130, HorizontalAlignment.Left)
                ListView2.Columns.Add("CUOTA", 100, HorizontalAlignment.Left)
                ListView2.Columns.Add("TASA", 75, HorizontalAlignment.Left)
                ListView2.Columns.Add("FORMALIZACIÓN", 170, HorizontalAlignment.Left)
                ...
                For Each credito As com.quarzo.gestiones6.BECrPrestamo In ws.Met_CreditosPorAsociado(credenciales, emplea2_encontrado)
                    ...
                    str2(0) = (credito.CDetalleLi)
                    str2(1) = (credito.NMontoApro).ToString("N2")
                    str2(2) = (credito.NSaldoCred).ToString("N2")
                    str2(3) = (credito.NCuotaReal).ToString("N2")
                    str2(4) = (credito.NTasaInter).ToString("N2")
                    str2(5) = (credito.DFechaForm)
